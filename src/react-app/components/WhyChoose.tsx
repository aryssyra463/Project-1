  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <h2 className="text-5xl md:text-6xl font-bold text-center text-blue-900 mb-12">Why Choose Us</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {points.map((point, index) => (
            <div 
              key={index} 
              className="text-center p-8 rounded-xl bg-white border border-gray-100 min-h-[280px] flex flex-col items-center justify-center
            ...
            >
              ...
              <h3 className="text-xl font-bold text-blue-900 mb-3">{point.title}</h3>
